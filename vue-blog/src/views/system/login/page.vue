      ...
      <div
        ...
        <div
          ...
          <div class="page-login--form">
            <el-card v-if="showLogin" shadow="never">
              <el-form
                ref="loginForm"
                label-position="top"
                :rules="rules"
            ...
            <p
              ...
              <span><router-link to="/">回到前台</router-link></span>
              <span @click="ShowLoginOrReg">注册用户</span>
            </p>
            <!-- quick login -->
    ...
    submit () {
      if (this.showLogin) {
        ...
        this.$refs['formReg'].validate((valid) => {
          if (valid) {
            httpProxy.post('/Register', {
              username: this.formReg.username,
              password: this.formReg.password,
              telephone: this.formReg.telephone
            }).then((e) => {
              if (e.status !== '102') {
                this.$message.success('注册成功!请登陆系统')
                this.showLogin = true
              } else {
